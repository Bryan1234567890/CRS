<div class="refund-modal" id="refundModal">
    ...
    <div class="refund-modal-inner">
                ...
                <div class="slides">
                    ...
                    <div class="slide slide-4">
                        ...
                        <div class="refund-modal-body-part refund-modal-track-result hidden">
                            ...
                            <div class="refund-modal-track-result-head refund-modal-txn-info hidden">
        ...
        <div class="refund-modal-footer">
            ...
            <div id="opt-buttons" class='footer-buttons hidden'>
                <button class="refund-modal-back">Back</button>
                <div>
                    <button class="opt-button refund-modal-refund-last refund-modal-refund hidden">Refund my last purchase</button>
    ...
    <div class="refund-modal-redirection-alert">
        <div class="refund-modal-redirection-alert-inner">
            <div class="refund-modal-redirection-alert-head">
